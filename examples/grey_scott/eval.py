...
def evaluate(config: ml_collections.ConfigDict, workdir: str):
    ...
    # Plot at all time steps
    fig = plt.figure(figsize=(18, 5))
    for i in range(100):
        plt.subplot(1, 3, 1)
        plt.pcolor(XX, YY, u_ref[i], cmap="jet")
        plt.colorbar()
        plt.xlabel("x")
        plt.ylabel("y")
        ...
        plt.subplot(1, 3, 2)
        plt.pcolor(XX, YY, u_pred[i], cmap="jet")
        plt.colorbar()
        plt.xlabel("x")
        plt.ylabel("y")
        ...
        plt.subplot(1, 3, 3)
        plt.pcolor(XX, YY, jnp.abs(u_ref[i] - u_pred[i]), cmap="jet")
        plt.colorbar()
        plt.xlabel("x")
        plt.ylabel("y")
        ...
        plt.subplot(1, 3, 1)
        plt.pcolor(XX, YY, v_ref[i], cmap="jet")
        plt.colorbar()
        plt.xlabel("x")
        plt.ylabel("y")
        ...
        plt.subplot(1, 3, 2)
        plt.pcolor(XX, YY, v_pred[i], cmap="jet")
        plt.colorbar()
        plt.xlabel("x")
        plt.ylabel("y")
        ...
        plt.subplot(1, 3, 3)
        plt.pcolor(XX, YY, jnp.abs(v_ref[i] - v_pred[i]), cmap="jet")
        plt.colorbar()
        plt.xlabel("x")
        plt.ylabel("y")
        plt.title("Absolute error")
